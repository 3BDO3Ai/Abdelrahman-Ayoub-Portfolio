...
const Portfolio: React.FC<PortfolioProps> = ({ toggleTheme, isDarkTheme }) => {
  ...
  useEffect(() => {
    const checkTheme = () => {
      if (typeof window !== 'undefined') {
        ...
        setIsDarkMode(bgColor === '#0f0f23' || bgColor === 'rgb(15, 15, 35)');
      }
    };
        ...
        <main style={{ 
          ...
          <aside 
            style={{
              ...
              borderRight: `1px solid ${isDarkMode ? 'rgba(255, 255, 255, 0.1)' : 'var(--border-color)'}`,
              padding: '2rem 1rem',
              overflow: 'auto',
              zIndex: 10,
            }}
          >
            ...
            <div style={{ marginTop: '2rem', paddingTop: '2rem', borderTop: `1px solid ${isDarkMode ? 'rgba(255, 255, 255, 0.1)' : 'var(--border-color)'}` }}>
              <h3 style={{
                fontSize: '1rem',
                fontWeight: 600,
                color: 'var(--text)',
              ...
              <div style={{ fontSize: '0.85rem', color: 'var(--text-light)' }}>
                <p style={{ marginBottom: '0.5rem' }}>
                  <strong style={{ color: 'var(--text)' }}>{resumeData.projects.length}</strong> Projects
                </p>
                <p style={{ marginBottom: '0.5rem' }}>
                  <strong style={{ color: 'var(--text)' }}>5+</strong> Technologies
                </p>
                <p style={{ marginBottom: '0.5rem' }}>
                  <strong style={{ color: 'var(--text)' }}>3+</strong> Years Experience
                </p>
              </div>
            </div>
          </aside>
