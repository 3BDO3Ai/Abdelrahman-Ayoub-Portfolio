...
import { FaSun, FaMoon, FaLinkedin, FaGithub, FaEnvelope, FaDownload, FaPaperclip, FaDiscord, FaPhone, FaMapMarkerAlt, FaBriefcase } from 'react-icons/fa';
...
const Header: React.FC<HeaderProps> = ({ toggleTheme, isDarkTheme, currentPage = 'home' }) => {
      ...
      <div className={styles.headerContainer}>
        <div className={`header-content ${styles.headerContent}`}>
          ...
          <div className={styles.socialLinks}>
            ...
            >
              <Link 
                href={currentPage === 'portfolio' ? '/' : '/portfolio'}
                style={{
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
              ...
              >
                <FaBriefcase size={16} />
                {currentPage === 'portfolio' ? 'View Resume' : 'View Portfolio'}
              </Link>
            </motion.div>
